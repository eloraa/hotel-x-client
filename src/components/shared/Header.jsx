...
export const Header = ({ alt }) => {
  ...
  return (
    <header className="py-[.85rem] md:px-10 px-5 flex items-center text-sm justify-between sticky top-0 z-[999] transition-[padding,margin-top] duration-100 mt-4">
      <Link to="/">
        <h1 className="relative z-[9999] group text-blue">
          <div className="w-14">
            <svg viewBox="0 0 56 15">
              <path
                ...
                fill="currentColor"
              />
              <path d="M1.49506 7.31942V5.76387H10.8284V7.31942H1.49506ZM9.72005 0.319427H11.3728V13.9305H9.72005V0.319427ZM0.581177 0.319427H2.23395V13.9305H0.581177V0.319427Z" fill="black" />
              <path d="M27.893 1.87498V0.319427H36.5458V1.87498H33.0458V13.9305H31.393V1.87498H27.893Z" fill="black" />
              <path
                ...
                fill="black"
              />
              <path d="M48.9834 0.319427H50.6361V12.375H55.9833V13.9305H48.9834V0.319427Z" fill="black" />
            </svg>
          </div>
        </h1>
      </Link>
