      ...
      <div className="flex flex-col justify-center items-center max-md:w-full md:px-10 px-5">
        <div className="md:px-10 px-5 py-14 bg-white rounded-lg text-center max-md:w-full">
          ...
          <form onSubmit={handleFormSubmit} className="mt-6 grid gap-4">
            ...
            <button className="bg-black w-full max-md:mt-6 py-4 md:px-32 px-0 text-white font-bold rounded-md active:scale-[.99] transition-transform text-sm">Register</button>
